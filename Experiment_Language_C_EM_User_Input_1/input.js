// this file was automatically generated by emscripten using the command "emcc input.c -s EXIT_RUNTIME=1" and has not been edited.
...
// end include: node_shell_read.js
  ...
  // not be needed with node v15 and input because it is now the default
  // behaviour:
        ...
        if (newSize == 0) {
          ...
          if (buffer.subarray && (!node.contents || node.contents.subarray)) { // This write is from a typed array to a typed array?
            if (canOwn) {
              ...
              return length;
            } else if (node.usedBytes === 0 && position === 0) { // If this is a simple first write to an empty file, do a fast set since we don't need to care input old data.
